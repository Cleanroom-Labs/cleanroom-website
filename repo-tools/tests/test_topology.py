"""Tests for repo_tools.topology."""

from pathlib import Path

from repo_tools.topology import (
...
class TestBuildEntries:
    def test_with_submodule_tree(self, tmp_submodule_tree: Path):
        ...
        from repo_tools.repo_utils import discover_repos
...
class TestTopologyCacheRecord:
    def test_record_from_real_repos(self, tmp_submodule_tree: Path):
        from repo_tools.repo_utils import discover_repos, run_git
