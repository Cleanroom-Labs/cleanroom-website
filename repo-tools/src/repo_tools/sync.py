...
Usage (via entry point):
    ...
    repo-tools sync --dry-run              # Preview changes
...
from repo_tools.config import SyncGroup, load_config
...
def _sync_group(
    ...
    if dry_run:
        ...
        print(f"  repo-tools sync {group.name}")
    elif push_failed:
