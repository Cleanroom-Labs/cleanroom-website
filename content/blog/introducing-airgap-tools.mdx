...
**Learn more**: [Cleanroom Whisper documentation](/docs/whisper/readme.html)
...
**Learn more**: [AirGap Deploy documentation](/docs/deploy/readme.html)
...
**Learn more**: [AirGap Transfer documentation](/docs/transfer/readme.html)
...
**Cleanroom Whisper**: Build from source with Cargo, configure whisper.cpp path, and start transcribing with global hotkeys. Useful for taking notes by voice or for accessibility needs. [Learn more](/docs/whisper/readme.html)

**AirGap Deploy**: Create a TOML manifest, run `airgap-deploy prep`, and generate deployment packages for air-gapped systems. [Learn more](/docs/deploy/readme.html)

**AirGap Transfer**: Split large files with `airgap-transfer pack`, physically transfer USB drives, and reconstruct with `airgap-transfer unpack`. [Learn more](/docs/transfer/readme.html)
