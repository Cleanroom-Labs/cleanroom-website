...
While "harvest now, decrypt later" targets encrypted traffic for future decryption, network surveillance infrastructure enables real-time collection today. For how mandated surveillance capabilities have already been exploited by foreign adversaries, see [Wired for Surveillance](/blog/wired-for-surveillance).
