...
For detailed technical specifications, see the [Cleanroom Whisper README](/docs/airgap-whisper/readme.html). This post focuses on how it works in practice.
...
- [Cleanroom Whisper README](/docs/airgap-whisper/readme.html) - Full project overview
