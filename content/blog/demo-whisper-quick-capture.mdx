...
For detailed technical specifications, see the [Cleanroom Whisper documentation](/docs/airgap-whisper/readme.html). This post focuses on how it works in practice.
...
Cleanroom Whisper will be available as part of the v1.0.0 release of the AirGap suite. Once released, you'll need:
...
- [Cleanroom Whisper documentation](/docs/airgap-whisper/readme.html) - Full project overview
- [Cleanroom Whisper Use Cases](/docs/airgap-whisper/use-cases/overview.html) - Detailed workflow scenarios
- [Introducing the AirGap Suite](/blog/introducing-airgap-suite) - How all three projects work together

---

*Capture your thoughts. Keep your privacy. Cleanroom Whisper makes it simple.*
