...
excerpt: "Learn how AirGap Whisper enables quick voice capture workflows without sending your audio to external servers."
...
For detailed technical specifications, see the [AirGap Whisper README](/docs/airgap-whisper/readme.html). This post focuses on how it works in practice.
...
**For deployment to air-gapped systems**, see the companion post on using [AirGap Deploy](/blog/demo-deploy-rust-app) to package AirGap Whisper with all its dependencies for offline installation.

**Want to learn more?**

- [AirGap Whisper README](/docs/airgap-whisper/readme.html) - Full project overview
- [AirGap Whisper Use Cases](/docs/airgap-whisper/use-cases/overview.html) - Detailed workflow scenarios
