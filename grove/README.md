...
`grove` provides a unified CLI for managing the complex git submodule hierarchy in the Cleanroom Labs website. The package includes subcommands for verifying, synchronizing, pushing, visualizing, and managing worktrees of nested submodules.
...
Install in development mode from the `grove/` directory:
